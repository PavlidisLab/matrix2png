...
pkglibexecdir = $(libexecdir)/matrix2png
...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	depcomp COPYING install-sh missing
...
STRIP = 
VERSION = 1.2.3
abs_builddir = /space/scratch/m2p-tmp/matrix2png-try1
abs_srcdir = /space/scratch/m2p-tmp/matrix2png-try1
abs_top_builddir = /space/scratch/m2p-tmp/matrix2png-try1
abs_top_srcdir = /space/scratch/m2p-tmp/matrix2png-try1
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /space/scratch/m2p-tmp/matrix2png-try1/install-sh
...
matrix2png$(EXEEXT): $(matrix2png_OBJECTS) $(matrix2png_DEPENDENCIES) $(EXTRA_matrix2png_DEPENDENCIES) 
	@rm -f matrix2png$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(matrix2png_OBJECTS) $(matrix2png_LDADD) $(LIBS)
