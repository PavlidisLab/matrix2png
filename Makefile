...
PRE_UNINSTALL = :
POST_UNINSTALL = :
ACLOCAL = ${SHELL} /users/pavlidis/netapps/projects/plotkit/src/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
...
AUTOMAKE = ${SHELL} /users/pavlidis/netapps/projects/plotkit/src/missing --run automake-1.7
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /users/pavlidis/netapps/projects/plotkit/src/missing --run makeinfo
OBJEXT = o
PACKAGE = matrix2png
PACKAGE_BUGREPORT = 
PACKAGE_NAME = 
